...
white_board.innerHTML =
  "<h2>About me</h2><p>I'm a student of 60th lyceum, where I'm studying in linguistic class. I find interesting studying and find something new. At the moment I studying IT because I want to connect my life with it. </p><h3 class='nmb'>1/3</p";
let i = 1;
leftArrow.addEventListener("click", () => {
  ...
  if (i === 1) {
    ...
    white_board.innerHTML =
      "<h2>IT</h2><p>Starting fro childhood, when I was a preschooler, the love to computers began to appear. And it didn't disappear, it was getting bigger ind bigger. So now, to develop my IT skills I ask parents to buy me courses. At the moment I'm studying in 'Step' academy and at the same time passing the 'JavaScript' course.</p><h3 class='nmb'>3/3</h3>";
  }
});
